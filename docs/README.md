...
| [Phase 4 GPU validation plan](plans/phase-4-gpu-validation.md) | What's done and what's missing for real-hardware CUDA/HIP validation, for execution on a machine with a physical GPU |
