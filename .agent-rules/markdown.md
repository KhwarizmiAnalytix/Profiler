...
Do not create summary, verification, completion, or analysis markdown files
unless the user asks for them. Describe the work in the response or pull
request instead. Update existing documentation when behavior changes.
